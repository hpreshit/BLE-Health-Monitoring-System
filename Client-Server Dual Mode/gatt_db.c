...
0x6b, 0xc2, 0x60, 0x71, 0x34, 0x88, 0x77, 0x94, 0xa0, 0x47, 0x9d, 0xb1, 0x5b, 0x1a, 0x15, 0xdb, 
0x90, 0x6f, 0x0f, 0xd9, 0xc3, 0x90, 0x0b, 0xa4, 0x1a, 0x4f, 0x41, 0x34, 0xdc, 0xa6, 0xff, 0x8e, 
0x98, 0xbe, 0x8f, 0xc7, 0x33, 0x49, 0x48, 0x8a, 0x01, 0x4e, 0x14, 0xc7, 0xdb, 0x24, 0x78, 0x06, 
0xcf, 0xd2, 0x36, 0x82, 0x3f, 0x00, 0xde, 0x9f, 0xea, 0x49, 0x92, 0x45, 0xf0, 0xf7, 0x05, 0xac, 
0x1c, 0x4f, 0x76, 0xb2, 0xec, 0x1d, 0xd1, 0x99, 0x7f, 0x40, 0xd5, 0xc3, 0xeb, 0x32, 0x82, 0xae, 
0xfc, 0xe8, 0xd3, 0x96, 0x0c, 0xa8, 0x39, 0xaa, 0x5c, 0x44, 0x5e, 0x7e, 0x85, 0xbe, 0xbf, 0x0b, 
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_35 ) = {
	.len=19,
	.data={0x34,0x25,0x00,0xfc,0xe8,0xd3,0x96,0x0c,0xa8,0x39,0xaa,0x5c,0x44,0x5e,0x7e,0x85,0xbe,0xbf,0x0b,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_34 ) = {
	.len=16,
	.data={0x1c,0x4f,0x76,0xb2,0xec,0x1d,0xd1,0x99,0x7f,0x40,0xd5,0xc3,0xeb,0x32,0x82,0xae,}
};
struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_32_data = {
	.len=1,
	.data={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_31 ) = {
	.len=19,
	.data={0x34,0x21,0x00,0xcf,0xd2,0x36,0x82,0x3f,0x00,0xde,0x9f,0xea,0x49,0x92,0x45,0xf0,0xf7,0x05,0xac,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_30 ) = {
	.len=16,
	.data={0x98,0xbe,0x8f,0xc7,0x33,0x49,0x48,0x8a,0x01,0x4e,0x14,0xc7,0xdb,0x24,0x78,0x06,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_27 ) = {
	.len=19,
	.data={0x34,0x1d,0x00,0x90,0x6f,0x0f,0xd9,0xc3,0x90,0x0b,0xa4,0x1a,0x4f,0x41,0x34,0xdc,0xa6,0xff,0x8e,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_26 ) = {
	.len=16,
	.data={0x6b,0xc2,0x60,0x71,0x34,0x88,0x77,0x94,0xa0,0x47,0x9d,0xb1,0x5b,0x1a,0x15,0xdb,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_23 ) = {
	.len=5,
	.data={0x28,0x19,0x00,0x9f,0x2a,}
};
uint8_t bg_gattdb_data_attribute_field_21_data[8]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,};
...
uint8_t bg_gattdb_data_attribute_field_6_data[13]={0x48,0x65,0x61,0x72,0x74,0x52,0x61,0x74,0x65,0x53,0x70,0x6f,0x32,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x000f,.permissions=0x800,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_2},
    ...
    {.uuid=0x000b,.permissions=0x804,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_21},
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x03,.index=0x03,.clientconfig_index=0x01}},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_23},
    {.uuid=0x000d,.permissions=0x802,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_24},
    ...
    {.uuid=0x8003,.permissions=0x804,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_28},
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x03,.index=0x05,.clientconfig_index=0x03}},
    ...
    {.uuid=0x8005,.permissions=0x804,.caps=0xffff,.datatype=0x02,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_32},
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x03,.index=0x06,.clientconfig_index=0x04}},
    ...
    {.uuid=0x8007,.permissions=0x804,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_36},
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x03,.index=0x07,.clientconfig_index=0x05}},
};
...
GATT_DATA(const uint8_t bg_gattdb_data_adv_uuid16_map[])={0x0d, 0x18, };
GATT_DATA(const uint8_t bg_gattdb_data_adv_uuid128_map[])={0x6b, 0xc2, 0x60, 0x71, 0x34, 0x88, 0x77, 0x94, 0xa0, 0x47, 0x9d, 0xb1, 0x5b, 0x1a, 0x15, 0xdb, 0x1c, 0x4f, 0x76, 0xb2, 0xec, 0x1d, 0xd1, 0x99, 0x7f, 0x40, 0xd5, 0xc3, 0xeb, 0x32, 0x82, 0xae, };
